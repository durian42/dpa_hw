...
Для наглядности [вот](https://colab.research.google.com/drive/1Pr2hWu4aqEmXaX2sUqseqDa78fR-FUp_) ноутбук в коллабе с графиком 
...
Связь красных смещений и фотометрического расстояния см. в [статье](https://www.astronet.ru/db/msg/1170612/node57.html). Фотометрическое расстояние d связано с зведной величиной m, данной вам в таблице как m ~ 5\*log(d).
...
По итогу у меня получилось что-то такое ![графкек](./IMAGE%rainfurrest.png), что кажется вполне неплохим результатом :з
